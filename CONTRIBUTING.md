...
Hi! Thanks for considering contributing to ckanext-iiif. :sauropod:
...
- [Issues](https://github.com/NaturalHistoryMuseum/ckanext-iiif/issues)
...
- [The documentation](https://ckanext-iiif.readthedocs.io)
- [The existing issues](https://github.com/NaturalHistoryMuseum/ckanext-iiif/issues?q=is:issue)
...
Our documentation is generated using [MkDocs](https://www.mkdocs.org), then hosted on [Read the Docs](https://about.readthedocs.com). You can view the current documentation for this repository at [ckanext-iiif.readthedocs.io](https://ckanext-iiif.readthedocs.io).
